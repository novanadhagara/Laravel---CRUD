    ...
    <div class="container">
        ...
        <form action="{{route('mahasiswa.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="namaSiswa" class="form-control" id="namaSiswa" placeholder="Nama Lengkap">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="emailSiswa" class="form-control" id="emailSiswa" placeholder="Email">
                </div>
            </div>
            <div class="form-group row">
                <label for="alamatRumah" class="col-sm-2 col-form-label">Alamat Rumah</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="alamatRumah" rows="8" cols="80" placeholder="Alamat Rumah"></textarea>
                    </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select id="pendidikanSiswa" name="pendidikanSiswa"class="form-control" placeholder="Pendidikan Terakhir">
                      <option>Pilih Pendidikan Terakhir </option>
                      <option value="2007">  SMA</option>
                      <option value="2008">  KULIAH</option>
            ...
            <div class="form-group row">
                <label for="saranAlumni" class="col-sm-2 col-form-label">Saran / Masukan untuk Ikatan Alumni Sekolah...</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="saranAlumni" rows="8" cols="80" placeholder="Saran / Masukan untuk Ikatan Alumni Sekolah..."></textarea>
                    </div>
            </div>
            <!--<div class="form-group row">
